...
<body>
    ...
    <main>
        <div class="container">
            ...
            <div class="reqCat">
                <div class="formT">あなたが請求するカタログ</div>
                <div class="catRectG flex a-c j-b">
                    <div class="catRect">I LACHIC (アイラシックホーム)</div>
                    <div class="catRect">I LACHIC (アイラシックホーム)</div>
                    <div class="catRect">I LACHIC (アイラシックホーム)</div>
                    <div class="catRect">総合建築アズ株式会社</div>
                </div>
            </div>
